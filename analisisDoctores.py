...
labelRegistro = tk.Label(frame_doctores, text="Registro de Doctores", font=("Arial", 12, "bold"))
...
#Años Experiencia
labelañoExp=tk.Label(frame_doctores,text="Año Experiencia:")
...
comboHospital=ttk.Combobox(frame_doctores,values=["Hospital Central","Clínica Norte","Centro Sur"],textvariable=centro_medico)
...
treeview2=ttk.Treeview(frame_doctores,columns=("Nombre","Especialidad","Año Experiencia","Género","Hospital"),show="headings")
#Definir encabezados
treeview2.heading("Nombre",text="Nombre")
treeview2.heading("Especialidad",text="Especialidad")
treeview2.heading("Año Experiencia",text="Año Experiencia")
...
treeview2.column("Año Experiencia",width=160,anchor="center")
treeview2.column("Género",width=120,anchor="center")
treeview2.column("Hospital",width=120,anchor="center")
#Indicar el TreeView en la cuadrícula
treeview2.grid(row=8,column=0,columnspan=2,sticky="nsew",padx=5,pady=10)
