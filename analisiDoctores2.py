...
def guardar_en_archivo():
    with open("pacientes.txt","w",encoding="utf-8") as archivo:   #utf_8 permite aceptar caracteres especiales y la letra ñ / with para cerrar correctamemte el archivo
...
labelRegistro = tk.Label(frame_doctores, text="Registro de Doctores", font=("Arial", 12, "bold"),bg="lightcyan")
labelRegistro.grid(row=0, column=0, columnspan=2, pady=10, sticky="n")

#Nombre
labelNombreD=tk.Label(frame_doctores,text="Nombre: ",bg="lightcyan")
...
#Especialidad
labelEspecialidad=tk.Label(frame_doctores,text="Especialidad:",bg="lightcyan")
...
#Años Experiencia
labelañoExp=tk.Label(frame_doctores,text="Años Experiencia:",bg="lightcyan")
labelañoExp.grid(row=3,column=0,padx=5,pady=5,sticky="w")
spin=tk.Spinbox(frame_doctores,from_=1,to=80)
spin.grid(row=3,column=1,padx=5,pady=5,sticky="w")

#Genero
labelGeneroD=tk.Label(frame_doctores,text="Género:",bg="lightcyan")
labelGeneroD.grid(row=4,column=0,sticky="w",padx=5,pady=5)

generoD=tk.StringVar()
generoD.set("Masculino") #Valor por defecto
radioMasculino=ttk.Radiobutton(frame_doctores, text="Masculino",variable=generoD,value="Masculino")
radioMasculino.grid(row=4,column=1,sticky="w",padx=5)

radioFemenino=ttk.Radiobutton(frame_doctores, text="Femenino",variable=generoD,value="Femenino")
radioFemenino.grid(row=5,column=1,sticky="w",padx=5)

#Hospital
labelHospital=tk.Label(frame_doctores,text="Hospital:",bg="lightcyan")
...
comboHospital=ttk.Combobox(frame_doctores,values=["Hospital Central","Clínica Norte","Centro Sur"],textvariable=hospital)
comboHospital.grid(row=6,column=1,sticky="w",padx=5,pady=5)

#Frame para los botones
btn_frame=tk.Frame(frame_doctores)
btn_frame.grid(row=7,column=0,columnspan=2,pady=5,sticky="w")
...
btn_registrar.grid(row=8, column=1, padx=10, pady=5, sticky="w")
btn_registrar.configure(bg="LightGreen")


treeview2=ttk.Treeview(frame_doctores,columns=("Nombre","Especialidad","Años Experiencia","Género","Hospital"),show="headings")
#Definir encabezados
treeview2.heading("Nombre",text="Nombre")
treeview2.heading("Especialidad",text="Especialidad")
treeview2.heading("Años Experiencia",text="Años Experiencia")
...
treeview2.column("Años Experiencia",width=160,anchor="center")
treeview2.column("Género",width=120,anchor="center")
treeview2.column("Hospital",width=120,anchor="center")
#Indicar el TreeView en la cuadrícula
